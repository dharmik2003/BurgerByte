...
const Reservation = () => {
  return (
      <div className="p-[2rem] bg-center bg-cover relative mt-[2rem] pb-[5rem] mb-[3rem] bg-[url('/images/bg-black.jpg')]">
        ...
        <div className='W-[80%] relative z-[20] mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-[3rem]'>
            <div className=''>
                ...
                <p className='text-[17px] mt-[1rem] text-white text-opacity-50'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tenetur vero illo eaque voluptate explicabo praesentium.</p>
                <div className='flex mt-[2rem] items-center space-x-4'>
                    ...
                    <div>
                        ...
                        <h1 className='text-[30px] text-yellow-300 font-bold'>+91 9988552211</h1>
                    </div>
                </div>
            </div>
            <ReservationForm/>
