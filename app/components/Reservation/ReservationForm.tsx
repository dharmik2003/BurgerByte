...
const ReservationForm = () => {
  return (
    <div className='w-[100%] bg-green-700 p-6 rounded-lg'>
        ...
        <div className='mt-[2rem] '>
            <div className='flex flex-col sm:flex-row space-y-3 sm:space-y-0 items-center w-[80%] mx-auto justify-between sm:space-x-3'>
                  <select className="px-5 w-[100%] py-2.5 bg-transparent rounded-lg outline-none font-bold text-[17px] text-white border-[2.2px] border-gray-100" name="people" id="people">
                  ...
                  <input type='date' className='w-[100%] px-5 py-2 bg-transparent rounded-lg outline-none font-bold text-[17px] text-white border-[2.2px] border-gray-100' />
            </div>
              <input type='time' className='px-5 py-2.5 bg-transparent block w-[80%] mx-auto mt-[1rem] rounded-lg outline-none font-bold text-[17px] text-white border-[2.2px] border-gray-100' />
